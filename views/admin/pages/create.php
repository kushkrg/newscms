...
<form method="POST" action="<?= url('admin/pages/store') ?>">
    ...
    <div class="form-stack">
        <div class="form-group">
            ...
            <input type="text" name="title" id="title" required placeholder="Page title">
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-section-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="meta_description" id="meta_description" class="small" placeholder="SEO description"></textarea>
                </div>
            </div>
        </div>
